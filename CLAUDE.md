...
**Start here:** the `03 Projects/` root docs - what's actively in flight (folder location is status: root = active; the docs are the source of truth)
...
This will:
- Write session summary to `06 Archive/OpenCairn/Session Logs/YYYY-MM-DD.md`
