...
1. **Scrape the pca.st episode page** (`_shared-rules-content.md` §26 ladder: static extract → fetch MCP → Codex web tooling) for an `og:audio` / enclosure URL. This also harvests episode metadata.
