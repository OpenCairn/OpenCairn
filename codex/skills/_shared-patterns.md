...
- **Veto-of-proposed-routes** — propose a destination per item; user pass = veto, not generate; unvetoed executes. → `goodnight` Step 9 (Whimsy batch), `migrate` component 3
