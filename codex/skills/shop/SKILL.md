...
**Constraints batch:**
- **Hard requirements** — a select-all-that-apply question collects the set; the conversational form can't capture order, so follow up with one line asking the user to rank their selections firmest → negotiable
