...
3. **If a match is found**, Read the hit first — a DOI or URL cited in a reading list, project note, or related note is a *mention*, not an existing archive. Report what the hit actually is and ask whether to update the existing note or skip. Do not create a duplicate.
