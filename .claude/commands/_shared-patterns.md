...
- **Value provenance check (SOURCE)** — written values trace to user, tool, or tag. → `park` Step 4(d), `goodnight` Step 14b, `_shared-rules.md §16` (brief evidence: primary/secondary/unverified)
