...
1. **Scrape the pca.st episode page** (`_shared-rules.md` §26 ladder: static extract → fetch MCP → `WebFetch`) for an `og:audio` / enclosure URL. This also harvests episode metadata.
