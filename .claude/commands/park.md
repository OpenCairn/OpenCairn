...
**Do this here — after Step 4, before Step 5 — not at Step 6.** Extend the Step 2(e) enumeration with everything Steps 3–4 changed (moves are an identifier class) per Step 6 and despatch that agent now, `run_in_background: true`. Step 6 below defines what it does and what its prompt contains; this step fixes *when*.
