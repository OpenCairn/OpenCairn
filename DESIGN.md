...
All sessions live in `06 Archive/Claude/Session Logs/YYYY-MM-DD.md`. Multiple sessions per day append to the same file. Each session gets a `## Session N` heading with summary, decisions, open loops, files touched, and pickup context.
